...
UPD: Почитал. Это возможность вызова обработчика с заданным шаблоном из которого можно руками собрать результат. Прикольно. Ну и да, в TS натурально, бага. Проявляется в компиляции под ES3/ES5. https://github.com/microsoft/TypeScript/issues/27460
