...
В чем отличие поведения этих четырёх фрагментов кода? (Функции `doSomething()` и `doSomethingElse()` возвращают промисы, которые долго и асинхронно что-то делают)
...
В разной литературе их описывают, как "избавление от ада с колбеками", как способ избавиться от огромных пирамид кода, постоянно вылезающих за правый край экрана.
